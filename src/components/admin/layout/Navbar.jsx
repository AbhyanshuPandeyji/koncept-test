...
const Navbar = () => {
  ...
  return (
    <>
      <div className="relative px-6 py-2 gap-2  flex items-center flex-wrap justify-between bg-white z-30 shadow-lg">
        ...
        <div className=" flex items-center gap-4">
          ...
          <div className=" flex items-center gap-2">
            <div className=" sm:w-[5rem] sm:h-[3rem] w-[3rem] h-[2rem] flex">
              <img src={logo} alt="logo" className=" w-full h-full" />
            </div>
            <div>
              <p className=" hidden sm:block text-4xl font-bold logo-color">
