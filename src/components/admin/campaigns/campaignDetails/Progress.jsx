...
const Progress = () => {
  ...
  return (
    <div className="fixed right-2 bottom-2 bg-white p-2 rounded-full shadow-2xl cursor-pointer">
      ...
      <div
        className={` absolute bottom-0 right-0 bg-white w-[24rem] sm:w-[24rem]  rounded-lg shadow-2xl p-2 ${progressView ? " translate-y-0" : " translate-y-[120%]"
          }  transition-all duration-300`}
      >
        <div className=" flex items-center gap-2 border-2 px-2 py-1 rounded-md">
          <button
        ...
        <div className=" px-2 py-6 border-2 my-1 rounded-md">
          {progressTab === "upload" && (
            <>
              {isUploading ? (
                <div className=" py-2">
